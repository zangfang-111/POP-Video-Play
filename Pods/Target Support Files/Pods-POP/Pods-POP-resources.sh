...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/BranchInvite/BranchInvite.bundle"
  ...
  install_resource "${PODS_ROOT}/InstagramAssetsPicker/Pod/Assets/InstagramAssetsPicker.bundle"
fi
