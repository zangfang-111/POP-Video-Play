...
- (void)loadView {
    ...
    self.inviteItemColor = [UIColor colorWithRed:248/255.0 green:161/255.0 blue:55/255.0 alpha:1];
...
- (void)configureSegmentedControl {
    self.segmentedControlHeightConstraint.constant = 80;
    self.segmentedControl.titleTextAttributes = @{NSForegroundColorAttributeName : [UIColor whiteColor]};
    self.segmentedControl.selectedTitleTextAttributes = @{NSFontAttributeName : [UIFont boldSystemFontOfSize:40.0f], NSForegroundColorAttributeName : [UIColor whiteColor]};
    self.segmentedControl.selectionIndicatorColor = [UIColor colorWithRed:248/255.0 green:161/255.0 blue:55/255.0 alpha:1];
